...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 19, 2025 at 12:41 PM
...
(5, 3, 'مقدمة', 'يقدم هذا الجزء نظرة عامة على لغة جافاسكريبت، تاريخها، أهميتها في تطوير الويب، وكيفية عملها داخل المتصفح. ستتعرف على أساسيات تشغيل جافاسكريبت في صفحات الويب وأدوات المطور التي تساعدك على التجربة والتصحيح.', 1, '2025-03-13 14:50:53', '2025-03-16 09:20:21'),
