...
<div class="container my-5">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">إدارة أجزاء القصة - {{ $story->title }}</li>
        </ol>
    </nav>

    <div class="d-flex justify-content-end mb-3">
        <a href="{{ route('volunteer.story_parts.create',$story->id) }}" class="btn btn-primary">إضافة جزء جديد</a>
    </div>
        ...
        <tbody>
            @foreach($storyParts as $part)
                <tr>
                    ...
                    <td class="align-middle">
                        <a href="{{ route('volunteer.story_parts.edit', $part->id) }}" class="btn btn-warning btn-sm">تعديل</a>
                        
                        <form action="{{ route('volunteer.story_parts.delete', $part->id) }}" method="POST" class="d-inline" onsubmit="return confirm('هل أنت متأكد؟')">
                            @csrf
