...
class VolunteerStoryPartController extends Controller
{
    public function index($story_id)
    {
        ...
        // dd($storyParts);
        return view('site.volunteer.stories.story_parts.index',['story' => $story,'storyParts'=>$storyParts]);
    }
    ...
    public function create($story_id)
    {
        ...
        return view('site.volunteer.stories.story_parts.create',['story_id' => $story_id,'current_order' => $current_order]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('volunteer.story_parts.index', $request->story_id)
    ...
    public function edit($id)
    {
        ...
        return view('site.volunteer.stories.story_parts.edit', ['storyPart' => $storyPart]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // Redirect with success message
        return redirect()->route('volunteer.story_parts.index', ['story_id' => $request->story_id])
    ...
    public function delete($id)
    {
        ...
        // Redirect with success message
        return redirect()->route('volunteer.story_parts.index', ['story_id' => $storyPart->story_id])
