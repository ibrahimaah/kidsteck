...
<div class="container my-5">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">تعديل قصة</li>
        </ol>
    </nav>
    ...
    <div class="card p-4">
        ...
        <form action="{{ route('volunteer.stories.update', $story->id) }}" method="POST">
            @csrf 
            ...
            <div class="row">
                <div class="col-md-12 mb-3">
                    ...
                    <textarea class="form-control" name="description" rows="4" required>{{ $story->description }}</textarea>
                </div>
            </div>
